## Extract amino acid sequences from GFF

This is s a convenient script that found on the internet made by Tejashree Modak. It extracts the amino acid sequences from .GFF file and lists them in a multi-fasta format, with a nice summary statistic output. The relevant github: https://github.com/tejashree1modak/AUGUSTUS-helpers/blob/master/get-fasta.sh.
